...
The system SHALL require chapter draft proposals to contain at least 2800 narrative characters and SHALL NOT reject an otherwise valid chapter draft solely because it exceeds a previous target upper bound.

#### Scenario: Draft below minimum is rejected

- **GIVEN** a chapter draft proposal has fewer than 2800 narrative characters
- **WHEN** chapter draft validation runs
- **THEN** the system SHALL reject the proposal
- **AND** the reply SHALL explain that the draft must be at least 2800 characters.
